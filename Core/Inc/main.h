...
#define IN3_PhaseA_Pin GPIO_PIN_9
#define IN3_PhaseA_GPIO_Port GPIOB
#define IN4_PhaseB_Pin GPIO_PIN_10
#define IN4_PhaseB_GPIO_Port GPIOC
#define Enable_A_PhaseStepper_Pin GPIO_PIN_7
#define Enable_A_PhaseStepper_GPIO_Port GPIOA
#define Enable_B_PhaseStepper_Pin GPIO_PIN_8
...
#define IN1_PhaseA_Pin GPIO_PIN_5
